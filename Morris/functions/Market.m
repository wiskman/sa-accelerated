...
%         OrderOfEntry = 1 + Comp1DoesLaunch*(Comp1LaunchTime < RE)+ ...
%                         Comp2DoesLaunch*(Comp2LaunchTime < RE) + ...
%                         Comp3DoesLaunch*(Comp3LaunchTime < RE);
...
% 
% 
%     function [absIncome,I1]  = income(T,I0)
%        % checks behavior of market at time T and calculates the income in
%        % [T, T+dt]
%        % T=[RE, endTime]
%        NumberOfEntries=1+Comp1DoesLaunch*(Comp1LaunchTime<T) + ...
...
%             I1=0;
%        elseif T>=RE && T<RE+RampTime  
%             absIncome = (I0+slope*dt/2)*dt;  % income from ramp time 
%             I1 = I0+slope*dt;
%        elseif T>=RampTime && T<=PatentExpiry
%             absIncome = I0*dt;                % income from peak 
%             I1=I0;
%        else    
%             absIncome = 0.1*I0*dt;  
%             I1=I0;                      % income from after PatentExpiry
%        end
%     end
